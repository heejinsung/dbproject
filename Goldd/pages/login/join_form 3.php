...
<html lang="en">
  <head>
    ...
    <!-- join form css link -->
    <link rel="stylesheet" href="/Goldd/css/join_form.css">
    ...
    <div class="wrap">
      ...
      <section class="contents join hasTitle">
        <div class="center">
          ...
          <div class="joinBox">
            <form action="/Goldd/php_process/login/insertMembers.php" method="post" name="memberForm">
    ...
    <script>
      $(function(){
        $("#idCheck").click(function(){
          const url = '/Goldd/php_process/login/member_check_id.php?id=' + $("#id").val();
