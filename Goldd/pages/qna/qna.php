...
<html lang="en">
  ...
  <body>
        ...
        <div class="center">
          ...
          <div class="qnaBoxes deWeBoxes">
            ...
            <div class="searchPaging clear">
              <div class="search">
                <form action="/Goldd/pages/qna/qna_search_result.php" method="post" name="qnaSearch" class="clear qnaSearch">
            ...
            <div class="writeBox clear">
              <div class="qnaGuide">
                  ...
                  if($userid==''){
                  ?>
                  <span><a href="/Goldd/pages/login/login_form.php">로그인</a></span>
                  <?php
                  } else {
                  ?>
                  <span><?=$userid?></span>
              ...
              <form action="/Goldd/php_process/pages/qna_insert.php?id=<?=$userid?>" method="post" class="writeForm" name="writeForm">
                <p class="qnaTitInput">
    ...
    <script src="/Goldd/js/qna_ajax.js"></script>
    <script>
