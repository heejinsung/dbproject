...
<html lang="en">
  <head>
    ...
    <!-- qna css link -->
    <link rel="stylesheet" href="/Goldd/css/qna.css">
        ...
        <div class="center">
          ...
          <div class="qnaBoxes qnaView deWeBoxes">
            ...
            <div class="writerInfo">
                <p>
                    Posted By <?=$ans_id?> No.<?=$ans_num?>  /  <?=$ans_reg?>  /  <?=$ans_hit?>  Hits
                </p>
            </div>
            <div class="writeBox clear">
              <form action="/Goldd/php_process/pages/qna_update.php?num=<?=$ans_num?>" method="post" class="writeForm" name="ansForm">
                <p class="qnaTitInput">
              ...
              ?>
              <button type="submit" class=""><a href="/Goldd/pages/qna/qna.php">돌아가기</a></button>
            ...
            <div class="ansResult">
              <p class="adminId">
                ...
                if ($userlevel == 1){
                ?>
                <a href="/Goldd/php_process/pages/ans_delete.php?num=<?=$rep_ans_num?>" class="ansDeleteBtn">삭제</a>
                <?php
                }
                ?>
            ...
            <div class="answerBox">
                <form action="/Goldd/php_process/pages/ans_insert.php?num=<?=$ans_num?>" method="post" name="ansInputForm" class="ansInputForm">
