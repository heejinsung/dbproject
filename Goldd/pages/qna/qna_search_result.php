                        ...
                        <ul class="qnaList ">
                            ...
                            <?php
                              ...
                              if(!$search_result_num){
                                echo '<li style="padding:10px; width:100%; text-align:center;">
                                데이터가 존재하지 않습니다. 검색 조건 및 검색어를 확인해 주세요.</li>';
                              } else {
                            ...
                            <li class="qnaContent clear">
                                ...
                                <span class="qnaTit"><a href="/Goldd/pages/qna/qna_view.php?num=<?=$result_num?>"><?=$result_tit?></a></span>

                                <?php
                                } else {
                                ?>

                                <span class="qnaTit"><a href="/Goldd/pages/qna/qna_view.php?num=<?=$result_num?>"><?=$result_tit?> [답변완료]</a></span>
