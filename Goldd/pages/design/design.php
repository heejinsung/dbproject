        ...
        <div class="center">
            ...
            <div class="designBox deWeBox">
              <div>
                <p class="designImg deWeImg">
                  <img src="/Goldd/data/design_page/thumb/<?=$thumb_path?>" alt="">
                </p>
                ...
                <div class="boxOverlay">
                  <a href="/Goldd/pages/design/design_detail.php?num=<?=$design_num?>"><i class="fa fa-search"></i></a>
                </div>
              </div>
            </div>
            <!-- end of designBox -->
          ...
          <div class="btns">
            ...
            ?>
              ...
              <a href="/Goldd/pages/design/design_input_form.php" class="commonBtn">Upload Contents</a>
            <?php
              } else {
            ?>
              <a href="#" class="commonBtn designLoadMore">Load More</a>
