...
<html lang="en">
  <head>
    ...
    <!-- design css link -->
    <link rel="stylesheet" href="/Goldd/css/web_design_input.css">
  ...
  <body>
      ...
      <section class="contents Upload hasTitle">
        <div class="center">
          ...
          <div class="designInputForm webDesignInput">
            <form action="/Goldd/php_process/pages/design_insert.php" method="post" name="design_form" enctype="multipart/form-data">
    ...
    <script src="/Goldd/js/design_upload.js"></script>
    <script>
