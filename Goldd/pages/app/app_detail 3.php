...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/Goldd/plugin/lightslider.css" />
  ...
  <body>
          ...
          <div class="appLeft deWeLeft">
            ...
            <div class="title">
              ...
              <div class="linkBox">
                ...
                <a href="/Goldd/pages/app/app.php">view all website</a>
              </div>
            </div>
            <!-- end of common title -->
            ...
            <div class="detailCon ">
              <div class="appFrameBox">
                <ul id="appMain">
                  <li>
                    <img src="/Goldd/data/app_page/app_main/<?=$app_detail_img?>" alt="">
                  </li>
                  <li>
                    <img src="/Goldd/data/app_page/app_main/app_main_005.png" alt="">
                  </li>
                  <li>
                    <img src="/Goldd/data/app_page/app_main/app_main_006.png" alt="">
                  </li>
                </ul>
              ...
              <div class="appStoreBtns">
                <a href="#"><img src="/Goldd/img/app_store.jpg" alt=""></a>
                <a href="#"><img src="/Goldd/img/google_play.jpg" alt=""></a>
              </div>
    ...
    <script src="/Goldd/plugin/lightslider.js"></script>
