<?php
  ...
  $img_upload_dir=$_SERVER['DOCUMENT_ROOT'].'/Goldd/data/web_page/pc/';
  $mobile_upload_dir=$_SERVER['DOCUMENT_ROOT'].'/Goldd/data/web_page/mobile/';
  $thumb_upload_dir=$_SERVER['DOCUMENT_ROOT'].'/Goldd/data/web_page/thumb/';
  ...
  echo "
    <script>
      location.href='/Goldd/pages/web/web.php';
    </script>
  ";
