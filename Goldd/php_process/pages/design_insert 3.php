<?php 
 ...
 //REQUEST는 GET,POST 둘다 받을수 있음 , POST는 갱신이 느릴수있음
  ...
  $img_upload_dir=$_SERVER['DOCUMENT_ROOT'].'/Goldd/data/design_page/';
  $thumb_upload_dir=$_SERVER['DOCUMENT_ROOT'].'/Goldd/data/design_page/thumb/';
  ...
  $sql = "insert into gold_de(GOLD_DE_tit, GOLD_DE_ser, GOLD_DE_des, GOLD_DE_img1, GOLD_DE_img2, GOLD_DE_thumb, GOLD_DE_cli, GOLD_DE_reg) value('$design_title', '$design_serial', '$design_desc', '$main_name', '$sub_name', '$thumbnail_name', '$design_client', '$regist_day')";

  mysqli_query($dbConn, $sql);

  echo "
    <script>
      location.href='/Goldd/pages/design/design.php';
    </script>
