<div class="detailApp">
  <div class="appTit">
    ...
    <a href="/Goldd/pages/app/app.php">View All</a>
  </div>
  ...
  <div class="appLinks">
    <div class="subAppImg">
      <img src="/Goldd/data/app_page/app_thumb/<?=$app_side_thumb?>" alt="">
    </div>
    <div class="subAppTxt">
      <a href="/Goldd/pages/app/app_detail.php?num=<?=$app_side_num?>"><?=$app_side_tit?></a>
      <em><?=$app_side_des?></em>
    </div>
  </div>
