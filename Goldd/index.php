          ...
          <div class="productBox clear">
            <div class="boxLeft">
              ...
              <div class="productImg">
                <img src="/Goldd/data/design_page/thumb/<?=$design_thumb?>" alt="" />
                <span class="outline">
            ...
            <div class="boxRight">
              ...
              <div class="productTxt">
                <div>
                  <h2><?=$design_tit?></h2>
                  <p><?=$design_des?></p>
                  <a href="/Goldd/pages/design/design_detail.php?num=<?=$design_num?>">view more</a>
                </div>
              </div>
        ...
        <div class="center clear">
          ...
          <div class="fashionBox men">
            <div class="fashionTxt ">
              ...
              <a href="/Goldd/pages/web/web.php">VIEW MORE</a>
            </div>
            ...
            <div class="fashionImg">
              <div>
                <img src="/Goldd/data/web_page/thumb/<?=$web_thumb?>" alt="" />
                <h2><?=$web_tit?></h2>
                <em class="cutTxt"><?=$web_des?></em>
                <a href="/Goldd/pages/web/web_detail.php?num=<?=$web_num?>">View Details</a>
              </div>
            </div>
            <!-- loop box -->
            <?php
          ...
          <div class="fashionBox women">
            <div class="fashionTxt">
              ...
              <a href="/Goldd/pages/app/app.php">VIEW MORE</a>
            </div>
            ...
            <div class="fashionImg">
              <div>
                <img src="/Goldd/data/app_page/app_thumb/<?=$app_thumb?>" alt="" />
                <h2><?=$app_tit?></h2>
                <em class="cutTxt"><?=$app_des?></em>
                <a href="/Goldd/pages/app/app_detail.php?num=<?=$app_num?>">View Details</a>
              </div>
            </div>
            <!-- loop box -->
            <?php
        ...
        <div class="center">
          ...
          <div class="contactBox">
            <div class="mapBox">
              <div class="map">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3165.6141745771474!2d127.0263201512552!3d37.49343017971267!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357ca15abb13d033%3A0x60ca567c806a9d0e!2z7ISc7Jq47Yq567OE7IucIOyEnOy0iOq1rCDshJzstIjrj5kg7ISc7LSI64yA66GcNzjquLggNDg!5e0!3m2!1sko!2skr!4v1608280846350!5m2!1sko!2skr"
                ></iframe>
              </div>
            </div>
            <div class="formBox">
